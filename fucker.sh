...
banner() {
    ...
    if ! [ -x "$(command -v figlet)" ]; then
        echo 'Introducing FUCKER'
    else
        figlet FUCKER
    fi
    if ! [ -x "$(command -v toilet)" ]; then
        echo -e "\e[4;34m This FUCKER Was Created By \e[1;32mJOGA YOGESH \e[0m"
    else
        echo -e "\e[1;34mCreated By \e[1;34m"
        toilet -f mono12 -F border Yogesh
    fi
    echo -e "\e[1;34m For Any Queries Join Me!!!\e[0m"
    echo -e "\e[1;32m   Telegram: https://t.me/JOGAYOGESH \e[0m"
    echo -e "\e[4;32m   What's app: +91 9110566354 \e[0m"
    echo " "
